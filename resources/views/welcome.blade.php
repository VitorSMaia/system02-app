...
{{--        <div class="bg-contain bg-center h-28 w-full bg-no-repeat" style="background-image: url({{ asset('img/n.png') }});"></div>--}}
    ...
    <div class="flex flex-col justify-center items-start mx-24 mt-24 space-y-10">
        ...
        <div class="border border-x-0 w-full border-y-2">
            ...
            <div class="text-xl font-light">
                <p>Utilize meu link do Scribd para ler/ouvir livros durante 60 dias de graça.</p>
